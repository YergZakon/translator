...
Протокол автоматической передачи задач: `docs/AGENT_HANDOFF_PROTOCOL.md`.

## Обязательный порядок перед любой работой

1. Прочитать PRD, этот файл, `docs/PROJECT_LEDGER.md` и протокол handoff.
...
- Полный формат и ограничения описаны в `docs/AGENT_HANDOFF_PROTOCOL.md`.

## Git и интеграция

- Codex и Claude Code работают в разных Git worktree (или отдельных клонах), а не в одном физическом checkout.
- Новые ветки: `codex/be-<task-id>-<slug>` и `claude/ios-<task-id>-<slug>`.

...
- Обновлено: 2026-07-15 09:15 +05:00
...
| `SessionService.recreateLeg` | session/clientLegId/reason → fresh leg credentials | Owner/session/client leg проверяются; новый `legId` и secret; старый secret не переиспользуется | Codex | IMPLEMENTED — BE-04 merged, IOS-12 consumer accepted |

...
| IOS-05 | iOS | InstallationAPI, device-only Keychain token и controlled 401 recovery | Antigravity + Codex review | IN_REVIEW | `antigravity/ios-ios-05-installation-auth` / PR #9 | Keychain storage abstraction, sensitive DTO, single-flight retry-once, tests | IOS-04, BE-03 contract | Codex security/contract findings fixed; exact-head macOS build and 20/20 XCTest green; merge BE-03, then sync final main before IOS-05 merge |

...
- Обновлено: 2026-07-15 09:56 +05:00
- PRD: `PRD_Realtime_Translator_iOS_30_days_v0.1.docx`, версия 0.1 от 2026-07-13
- Состояние проекта: `READY_FOR_PARALLEL_WORK`
- Git: `origin/main` = `78edc2752447bf2960a92ed5ec9ffe7e13069a29` после merge PR #22 (BE-05); репозиторий `https://github.com/YergZakon/translator.git`
- Codex: backend owner; BE-05 merged и deployed на Stage; следующая backend-задача требует отдельной reservation/authorization

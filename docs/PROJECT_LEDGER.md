...
- Обновлено: 2026-07-14 11:20 +05:00
...
| CI-01 | Shared | macOS CI для XcodeGen, iOS build и unit tests | Codex | IN_PROGRESS | PR #3 / `codex/ci-ios-pr3` | `.github/workflows/ios-ci.yml` | IOS-01, IOS-02 | GitHub-hosted `macos-15`; build/test logs |

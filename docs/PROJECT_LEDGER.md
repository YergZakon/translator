...
- Обновлено: 2026-07-15 05:50 +05:00
- PRD: `PRD_Realtime_Translator_iOS_30_days_v0.1.docx`, версия 0.1 от 2026-07-13
- Состояние проекта: `READY_FOR_PARALLEL_WORK`
- Git: `origin/main` = `30fa0ff42d301f424d60640e19307bfaee3e7977` после merge PR #16 (BE-04 leg recreate); репозиторий `https://github.com/YergZakon/translator.git`
- Codex: backend owner; BE-04 merged, DONE
...
| BE-04 | Backend | Пересоздание translation leg с новым short-lived secret при reconnect | Codex | DONE | `codex/be-04-leg-recreate` / PR #16 | `POST /v1/translation-sessions/{sessionId}/legs`; ownership/idempotency; backend tests | BE-02, API-01, H-006 | PR #16 merged into `main` as `30fa0ff`; exact-head Backend CI `29378892257` success; Claude H-012 revision 2 approved |

...
- Обновлено: 2026-07-15 09:33 +05:00
...
| BE-05 | Backend | PostgreSQL persistence для translation sessions, legs и create/recreate idempotency | Codex | IN_PROGRESS | `codex/be-05-session-persistence` | versioned migration, repository/service wiring, PostgreSQL integration tests; без изменения OpenAPI/Swift DTO | BE-03, BE-04, IOS-12, D-006 | Draft PR, exact-head Backend CI и read-only Claude iOS-consumer review обязательны до отдельного разрешения на merge/deploy |

...
- Обновлено: 2026-07-14 16:23 +05:00
...
| STAGE-01 | Backend/DevOps | Railway stage: PostgreSQL, production container, runtime secrets, public health и API smoke | Codex | IN_PROGRESS | `codex/stage-01-railway` | `railway.json`, Railway project/services, stage URL и sanitized smoke report | BE-02, BE-03, CI-02 | `/v1/health`; installation → config → translation-session; secrets/logs remain redacted |
